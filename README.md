...
All deck data persists in localStorage. The assistant requires server env vars in `.env.local`. If you use licensed tldraw features, set `SLIDEBOARD_TLDRAW_LICENSE_KEY` in `.env.local`.
